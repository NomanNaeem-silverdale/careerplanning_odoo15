...
class EmployeeProfile(models.Model):
    ...
    course_id = fields.Many2many("slide.channel",string='Courses')
...
class CareerPlan(models.Model):
    ...
    goals_id = fields.One2many('career.goal', 'career_plan', string='Goals',tracking=True)
...
class Goal(models.Model):
    ...
    priority = fields.Selection(selection=[('0', 'vLow'),('1', 'Low'), ('2', 'Medium'), ('3', 'High')], string='Priority',
                                default='1',tracking=True)
    state = fields.Selection(selection=[('pending', 'Pending'), ('in_progress', 'In Progress'), ('completed', 'Completed') ,('draft', 'Draft')],
